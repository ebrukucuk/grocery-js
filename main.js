...
function addItem(e) {
    e.preventDefault(); // tıklandı formunu otomatik olarak gönderilmesini engelledi
    const value = grocery.value; // formdaki inputun değerini alma
    const id = new Date().getTime().toString(); // sayıyı yzıay çevirme
...
function clearItems() {
    ...
    container.classList.remove("show-container"); //konteynerı gizlemek için
